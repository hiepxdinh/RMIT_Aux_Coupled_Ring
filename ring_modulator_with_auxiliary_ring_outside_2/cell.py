...
from heater_outside_10Ghz_2 import Hiephiep_Top
...
class AddDropRingWithAuxOutside_Top_Euler(i3.PCell):
    """
    ...
    class Layout(i3.LayoutView):
        ...
        def _default_ring_1(self):
            ...
            ring_cell_layout.set(angle=180,
                                 ...
                                 straight_length=0)
            trace_length=self.cell.ring_1.get_default_view(i3.LayoutView).trace_length()
            print("Length of Euler bend 1: {}".format(trace_length))
        ...
        def _default_ring_2(self):
            ...
            ring_cell_layout.set(angle=180,
                                 bend_radius=self.ring_radius,
                                 straight_length=0)
            trace_length=self.cell.ring_2.get_default_view(i3.LayoutView).trace_length()
            print("Length of Euler bend 2: {}".format(trace_length))
            return ring_cell_layout

        def _default_ring_aux_1(self):

            ring_aux_cell_layout = self.cell.ring_aux_1.get_default_view(i3.LayoutView)
            ring_aux_cell_layout.set(angle=180,
                                 bend_radius=self.ring_radius,
                                 straight_length=0)

            trace_length=self.cell.ring_aux_1.get_default_view(i3.LayoutView).trace_length()
            print("Length of Euler bend aux 1: {}".format(trace_length))
        ...
        def _generate_instances(self, insts):
            ...
            print(self.ring_radius)

            insts += i3.SRef(name='ring_1', reference=self.ring_1,
                             position=(-self.ring_straight_length * 0.5, self.ring_radius), transformation=i3.HMirror()+i3.VMirror())
            insts += i3.SRef(name='ring_2', reference=self.ring_2, position=(self.ring_straight_length * 0.5, self.ring_radius), transformation=i3.VMirror())

            ring_1_in = [-self.ring_straight_length * 0.5, self.ring_radius]
            ring_2_in = [self.ring_straight_length * 0.5, self.ring_radius]
            ...
            ring_1_in = [-self.ring_straight_length * 0.5, -self.ring_radius- 40.229]
            ring_2_in = [self.ring_straight_length * 0.5, -self.ring_radius- 40.229]
            ...
            insts += i3.SRef(name='ring_aux_1', reference=self.ring_aux_1, position=(self.ring_straight_length*0.4390+self.ring_straight_length_aux * 0.5+164.128,
                                                                                      self.ring_radius-440.229- self.ring_wg_width - self.aux_coupling_gap), transformation=i3.VMirror())
            insts += i3.SRef(name='ring_aux_2', reference=self.ring_aux_1, position=(self.ring_straight_length*0.4390-self.ring_straight_length_aux * 0.5+164.128,
                                                                                      self.ring_radius-440.229- self.ring_wg_width - self.aux_coupling_gap), transformation=i3.HMirror()+i3.VMirror())

            ring_aux_1_in = [self.ring_straight_length*0.4390-self.ring_straight_length_aux * 0.5+164.128,
                                                                                      self.ring_radius-440.229- self.ring_wg_width - self.aux_coupling_gap]
            ring_aux_2_in = [self.ring_straight_length*0.4390+self.ring_straight_length_aux * 0.5+164.128,
                                                                                      self.ring_radius-440.229- self.ring_wg_width - self.aux_coupling_gap]

            link1_shape1 = i3.Shape([ring_aux_1_in, ring_aux_2_in])
            ...
            ring_aux_1_in = [self.ring_straight_length*0.4390-self.ring_straight_length_aux * 0.5+164.128,
                                                                                      self.ring_radius-440.229*2- self.ring_wg_width - self.aux_coupling_gap]
            ring_aux_2_in = [self.ring_straight_length*0.4390+self.ring_straight_length_aux * 0.5+164.128,
                                                                                      self.ring_radius-440.229*2- self.ring_wg_width - self.aux_coupling_gap]
            ...
            insts += i3.SRef(name='bus_in_through', reference=self.bus_waveguide,
                             position=(self.coupler_positions[0], -self.ring_radius - self.ring_wg_width * 0.5 - self.coupler_spacing - self.bus_wg_width * 0.5- 40.229))
            insts += i3.SRef(name='bus_add_drop', reference=self.bus_waveguide,
                             position=(self.coupler_positions[1], -self.ring_radius - self.ring_wg_width * 0.5 - self.coupler_spacing - self.bus_wg_width * 0.5- 40.229)
                             )

            # Heater
            insts += i3.SRef(name='heater', reference=self.heater,position=(self.ring_straight_length*0.4390 -self.ring_straight_length_aux*0.5-self.ring_radius_aux-4+182+2, -self.ring_radius-self.ring_radius_aux- self.ring_wg_width-self.aux_coupling_gap- 40.229*2-20-6))
...
class AddDropRingWithAuxOutside_Top_Euler_2(i3.PCell):
    """
    Add-drop racetrack ring with a travelling electrode
    """
    ring_trace_template = i3.TraceTemplateProperty(doc="the trace template for ring")
    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_instances(self, insts):
            ...
            insts += i3.SRef(name='ring_1', reference=self.ring_1,
                             position=(-self.ring_straight_length * 0.5, self.ring_radius),
                             transformation=i3.HMirror() + i3.VMirror())
            insts += i3.SRef(name='ring_2', reference=self.ring_2,
                             position=(self.ring_straight_length * 0.5, self.ring_radius), transformation=i3.VMirror())
            ...
            insts += i3.SRef(name='bus_in_through', reference=self.bus_waveguide,
                             position=(self.coupler_positions[0],
                                       -self.ring_radius - self.ring_wg_width * 0.5 - self.coupler_spacing - self.bus_wg_width * 0.5 - 40.229))
            insts += i3.SRef(name='bus_add_drop', reference=self.bus_waveguide,
...
# class AddDropRingWithAuxOutside_Top(i3.PCell):
#     """
#     Add-drop racetrack ring with a travelling electrode
#     """
#     ring_trace_template = i3.TraceTemplateProperty(doc="the trace template for ring")
...
#             # insts += i3.SRef(name='ring2', reference=self.ring_aux, position=(self.ring_straight_length*0.3, -self.ring_radius-self.ring_radius_aux- ring_wg_width-self.aux_coupling_gap))
#             insts += i3.SRef(name='ring_aux_1', reference=self.ring_aux_1, position=(self.ring_straight_length * 0.3,
#                                                                                      -self.ring_radius - self.ring_radius_aux - ring_wg_width - self.aux_coupling_gap))
#             insts += i3.SRef(name='ring_aux_2', reference=self.ring_aux_2, position=(self.ring_straight_length * 0.3,
#                                                                                      -self.ring_radius - self.ring_radius_aux - ring_wg_width - self.aux_coupling_gap))
#             insts += i3.SRef(name='bus_in_through', reference=self.bus_waveguide,
#                              position=(self.coupler_positions[0],
...
#             self.ring_straight_length * 0.3 - self.ring_straight_length_aux * 0.5 - self.ring_radius_aux - 4,
#             -self.ring_radius - self.ring_radius_aux - ring_wg_width - self.aux_coupling_gap))
#
#             # RF electrode
#             insts += i3.SRef(name='electrode', reference=self.rf_electrode,
