...
from heater_outside_10Ghz import Hiephiep
...
class AddDropRingWithAuxOutside_Euler(i3.PCell):
    """
    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_instances(self, insts):
            ...
            insts += i3.SRef(name='ring_1', reference=self.ring_1,
                             position=(-self.ring_straight_length * 0.5, self.ring_radius+self.ground_width+self.electrode_gap+50*2-43.785 + 2.785), transformation=i3.HMirror())
            insts += i3.SRef(name='ring_2', reference=self.ring_2, position=(self.ring_straight_length * 0.5, self.ring_radius+self.ground_width+self.electrode_gap+50*2-43.785+ 2.785))

            ring_1_in = [-self.ring_straight_length * 0.5, self.ring_radius+self.ground_width+self.electrode_gap+50*2-43.785+ 2.785]
            ring_2_in = [self.ring_straight_length * 0.5, self.ring_radius+self.ground_width+self.electrode_gap+50*2-43.785+ 2.785]
            ...
            ring_1_in = [-self.ring_straight_length * 0.5, self.ring_radius+self.ground_width+self.electrode_gap+50*2-43.785+ 2.785 + 440.229]
            ring_2_in = [self.ring_straight_length * 0.5, self.ring_radius+self.ground_width+self.electrode_gap+50*2-43.785+ 2.785 + 440.229]
            ...
            insts += i3.SRef(name='ring_aux_1', reference=self.ring_aux_1,
                             position=(self.ring_straight_length * 0.4390 + self.ring_straight_length_aux * 0.5+164.128,
                                       self.ring_radius - 440.229 - self.ring_wg_width - self.aux_coupling_gap),
                             transformation=i3.VMirror())
            insts += i3.SRef(name='ring_aux_2', reference=self.ring_aux_1,
                             position=(self.ring_straight_length * 0.4390- self.ring_straight_length_aux * 0.5+164.128,
                                       self.ring_radius - 440.229 - self.ring_wg_width - self.aux_coupling_gap),
            ...
            # Heater
            insts += i3.SRef(name='heater', reference=self.heater,position=(self.ring_straight_length*0.4390 -self.ring_straight_length_aux*0.5-self.ring_radius_aux-4+182+2, -self.ring_radius-self.ring_radius_aux- self.ring_wg_width-self.aux_coupling_gap- 40.229*2-20-4.25-2.785+1))
...
# class AddDropRingWithAuxOutside(i3.PCell):
#     """
#     Add-drop racetrack ring with a travelling electrode
#     """
#     ring_trace_template = i3.TraceTemplateProperty(doc="the trace template for ring")
