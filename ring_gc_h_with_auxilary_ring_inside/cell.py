...
if int(ipkiss_version[0]) <= 3 and int(ipkiss_version[1]) < 7:
    ...
    class RingModulatorGCHiepAuxInside(PlaceAndAutoRoute):
        ...
        def _default_ring(self):
            return AddDropRingWithAuxInside(ring_trace_template=self.trace_template,
    ...
    class RingModulatorGCHiepAuxInside(i3.Circuit):
        ring = i3.ChildCellProperty(doc="the ring modulator")
        gc = i3.ChildCellProperty(doc="the grating coupler")
        trace_template = i3.TraceTemplateProperty(doc="the trace template for the circuit")
        ...
        def _default_specs(self):
            return [
                ...
                i3.ConnectManhattan(
                    ...
                    control_points=[i3.H(i3.START - self.gc_wg_distance+225),
                                    ],
                ...
                i3.ConnectManhattan(
                    "through_grating:out", "ring:through",
                    control_points=[i3.H(i3.START - self.gc_wg_distance + self.waveguide_spacing+225)
                                    ],
                    bend_radius=self.bend_radius,
                ),
                ...
                i3.ConnectManhattan(
                    "add_grating:out", "ring:add",
                    control_points=[i3.H(i3.START - self.gc_wg_distance + self.waveguide_spacing * 2 +225)
                                    ],
                    bend_radius=self.bend_radius,
                ),
                ...
                i3.ConnectManhattan(
                    "drop_grating:out", "ring:drop",
                    control_points=[i3.H(i3.START - self.gc_wg_distance + self.waveguide_spacing * 3 +225)
                                    ],
                    bend_radius=self.bend_radius,
                )
