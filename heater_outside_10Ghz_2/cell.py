...
class Hiephiep_Top(i3.PCell):
    ...
    class Layout(i3.LayoutView):
        ...
        def _default_hiep_wire_heater(self):
            ...
            euler_shape = _partial_euler(angle=180, radius=440.229/2+4, p=0.5, use_effective_radius=use_effective_radius)

            short_shape = i3.ShapeShorten(original_shape=euler_shape,
                                          trim_lengths=(0, 476))

            shape_2 = i3.Shape([(-238.5+2.5+507+47.5+50, 440.229/2+22-10-0.65), (-238.5+2.5+48+507+47.5+50, 440.229/2+22-10-0.65)])
        ...
        #     electric_wire_shape = i3.Shape([(-1390, 650+700), (-1390, 850), (0, 850), (0, self.electric_wire_length)])
        ...
        #     electric_wire_shape = i3.Shape([(-2210, 150+700), (-2210, 200), (0, 200), (0, self.electric_wire_length-500)])
        #     hiep_electric_wire_layout.set(shape=electric_wire_shape)
        #     return hiep_electric_wire_layout

        def _default_hiep_electric_wire(self):
            hiep_electric_wire_layout = self.cell.hiep_electric_wire.get_default_view(i3.LayoutView)
            electric_wire_shape = i3.Shape([(550-2120-800-34, 2200-150-75), (550-2120-800-34, 2200), (2150+150-700+650-350,2200), (2150+150-700+650-350, 650), (-27+2.5-181-45, 650), (-27+2.5-181-45, self.electric_wire_length+40+8+11)])
            hiep_electric_wire_layout.set(shape=electric_wire_shape)
            return hiep_electric_wire_layout

        def _default_hiep_electric_wire2(self):
            hiep_electric_wire_layout = self.cell.hiep_electric_wire2.get_default_view(i3.LayoutView)
            electric_wire_shape = i3.Shape([(550-2520-800-800+54, 1550),(550-800-800+54, 1550), (1250-500+550-800, 1550), (1250-500+550-800, 350), (31-2.5+181, 350), (31-2.5+181, self.electric_wire_length-500+40+8+11)])
            hiep_electric_wire_layout.set(shape=electric_wire_shape)
            return hiep_electric_wire_layout
        ...
        def _generate_instances(self, insts):
            ...
            # insts += i3.SRef(name='in_pad20_left', reference=self.hiep_pad_heater_2020_top,position=(159.45 - 5345 + 410 -0.45+1+1600-29+13 + 4-4178+5.45,-self.electric_wire_length+650+700+250-25+5+98.5+ 46.264-100-26.422+2.5))
            # insts += i3.SRef(name='mid_pad20_left', reference=self.hiep_pad_heater_2020_mod,position=(159.45 - 5345+ 410 -0.45+1.5+2000-416.5+ 4-4178+5.45,-self.electric_wire_length+650+700+350-39+1.5+14.95+ 46.264-100-26.422+2.5))
            # insts += i3.SRef(name='out_pad20_left', reference=self.hiep_pad_heater_2020,position=(159.45 - 5345+ 410 -0.45+35+1.25+ 4-4178+5.45,-self.electric_wire_length+650+700+450-32+2.5-25.55+ 46.264-100-26.422+2.5))
            #
            # insts += i3.SRef(name='in_pad20_right', reference=self.hiep_pad_heater_2020_top_reverse,position=(159.45 - 5345+ 410 -0.45+ 6345 +20-15-1600+30+ 4-652.3-97.5-4,-self.electric_wire_length+650+700+250-25+5+98.5+ 46.264-100-26.422+2.5))
            # insts += i3.SRef(name='mid_pad20_right', reference=self.hiep_pad_heater_2020_mod_reverse,position=(159.45 - 5345+ 410 -0.45+ 6345 +20+1.5-2003+416.5+ 4-652.3-97.5-4,-self.electric_wire_length+650+700+350-39+1.5+14.95+ 46.264-100-26.422+2.5))
            # insts += i3.SRef(name='out_pad20_right', reference=self.hiep_pad_heater_2020,position=(159.45 - 5345+ 410 -0.45 + 6345 +20-35-1.25+ 4-652.3-97.5-4,-self.electric_wire_length+650+700+450-32+2.5-25.55+ 46.264-100-26.422+2.5))

            insts += i3.SRef(name ='in_pad_2', reference=self.hiep_pad_heater, position=(-1805+50-800,-self.electric_wire_length+650+700+650+50))
            insts += i3.SRef(name ='in_pad', reference=self.hiep_pad_heater, position=(-1605+50-800,-self.electric_wire_length+650+700+650+50))
            insts += i3.SRef(name='out_pad', reference=self.hiep_pad_heater,position=(-1405+50-800, -self.electric_wire_length+650+700+650+50))
            insts += i3.SRef(name='wire_in',reference=self.hiep_electric_wire, position=(0+43, -self.electric_wire_length))
            insts += i3.SRef(name='wire_out',reference=self.hiep_electric_wire2,position=(self.pad_spacing-40, -self.electric_wire_length+500))
