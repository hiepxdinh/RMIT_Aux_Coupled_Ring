...
from ring_modulator_with_auxiliary_ring_outside_19GHz.cell import AddDropRingWithAuxOutside2, AddDropRingWithAuxOutside3
...
if int(ipkiss_version[0]) <= 3 and int(ipkiss_version[1]) < 7:
    ...
    class RingModulatorGCHiepAuxOutside2(PlaceAndAutoRoute):
        ...
        def _default_ring(self):
            return AddDropRingWithAuxOutside2(ring_trace_template=self.trace_template,
        ...
        class Layout(PlaceAndAutoRoute.Layout):
            ...
            ground_width = i3.PositiveNumberProperty(default=120.0, doc="width of the ground planes")
            ground_width_mod = i3.PositiveNumberProperty(default=65.0, doc="width of the ground planes")
            electrode_gap = i3.PositiveNumberProperty(default=7.0, doc="gap between hot electrode and ground plane")
            hot_taper_width = i3.PositiveNumberProperty(default=60.0,
    ...
    class RingModulatorGCHiepAuxOutside2(i3.Circuit):
        ring = i3.ChildCellProperty(doc="the ring modulator")
        gc = i3.ChildCellProperty(doc="the grating coupler")
        trace_template = i3.TraceTemplateProperty(doc="the trace template for the circuit")
        gc_spacing = i3.PositiveNumberProperty(default=127, doc="fibre array pich")
        ...
        def _default_specs(self):
            return [
                ...
                i3.ConnectManhattan(
                    ...
                    control_points=[i3.H(i3.START - self.gc_wg_distance+ self.waveguide_spacing * 5 + 50)
                                    ],
                ...
                i3.ConnectManhattan(
                    "through_grating:out", "ring:through",
                    control_points=[i3.H(i3.START - self.gc_wg_distance + self.waveguide_spacing*4 + 50)
                                    ],
                    bend_radius=self.bend_radius,
                ),
                ...
                i3.ConnectManhattan(
                    "add_grating:out", "ring:add",
                    control_points=[i3.H(i3.START - self.gc_wg_distance + self.waveguide_spacing * 3 + 50)
                                    ],
                    bend_radius=self.bend_radius,
                ),
                ...
                i3.ConnectManhattan(
                    "drop_grating:out", "ring:drop",
                    #control_points=[i3.H(i3.START - self.gc_wg_distance+ self.waveguide_spacing + 50)
                    #                ],
                    bend_radius=self.bend_radius,
                )
            ...
            def _generate_elements(self, elems):
                ...
                if self.with_label:
                    elems += i3.PolygonText(layer=i3.TECH.PPLAYER.RWG.TEXT,
                                            ...
                                            text="CG-" + str(self.coupler_gap_Hiep * 1000) + "nm" + "_" + "EG-" + str(self.electrode_gap_Hiep * 1000)+ "nm" + "_" +"AUX-CG-"+str(self.aux_coupling_gap*1000)+ "nm",
                                            height= 50,
    ...
    class RingModulatorGCHiepAuxOutside3(i3.Circuit):
        ring = i3.ChildCellProperty(doc="the ring modulator")
        gc = i3.ChildCellProperty(doc="the grating coupler")
        trace_template = i3.TraceTemplateProperty(doc="the trace template for the circuit")
        gc_spacing = i3.PositiveNumberProperty(default=127, doc="fibre array pich")
        ...
        def _default_ring(self):
            return AddDropRingWithAuxOutside3(ring_trace_template=self.trace_template,
                                            bus_trace_template=self.trace_template)
