...
class Hiephiep_Top(i3.PCell):
    ...
    class Layout(i3.LayoutView):
        ...
        #     electric_wire_shape = i3.Shape([(1845, 150+700), (1845, 200), (1600, 200), (0, 200), (0, self.electric_wire_length-500)])
        ...
        #     electric_wire_shape = i3.Shape([(1000, 650+700), (1000, 850), (0, 850), (0, self.electric_wire_length)])
        #     hiep_electric_wire_layout.set(shape=electric_wire_shape)
        #     return hiep_electric_wire_layout

        def _default_hiep_electric_wire(self):
            hiep_electric_wire_layout = self.cell.hiep_electric_wire.get_default_view(i3.LayoutView)
            electric_wire_shape = i3.Shape([(1580, 1550), (-200-150, 1550), (-200-150, 350), (-27+2.5, 350), (-27+2.5, self.electric_wire_length-500+2.5)])
            hiep_electric_wire_layout.set(shape=electric_wire_shape)
            return hiep_electric_wire_layout

        def _default_hiep_electric_wire2(self):
            hiep_electric_wire_layout = self.cell.hiep_electric_wire2.get_default_view(i3.LayoutView)
            electric_wire_shape = i3.Shape([(1150, 2200-150), (1150, 2200),(-1000-150, 2200), (-1000-150, 650), (31-2.5, 650), (31-2.5, self.electric_wire_length+2.5)])
            hiep_electric_wire_layout.set(shape=electric_wire_shape)
            return hiep_electric_wire_layout
        ...
        def _generate_instances(self, insts):
            ...
            insts += i3.SRef(name='in_pad20_left', reference=self.hiep_pad_heater_2020_top,position=(159.45+15+1462+108+ 4,-self.electric_wire_length+650+700+250-25+5+98.5+ 46.264))
            insts += i3.SRef(name='mid_pad20_left', reference=self.hiep_pad_heater_2020_mod,position=(159.45+1.5+2000-416.5+ 4,-self.electric_wire_length+650+700+350-39+1.5+14.95+ 46.264))
            insts += i3.SRef(name='out_pad20_left', reference=self.hiep_pad_heater_2020,position=(159.45+35+1.25+ 4,-self.electric_wire_length+650+700+450-32+2.5-25.55+ 46.264))

            insts += i3.SRef(name='in_pad20_right', reference=self.hiep_pad_heater_2020_top_reverse,position=(159.45 + 2811+20-15-1600+30+ 4,-self.electric_wire_length+650+700+250-25+5+98.5+ 46.264))
            insts += i3.SRef(name='mid_pad20_right', reference=self.hiep_pad_heater_2020_mod_reverse,position=(159.45 + 2811+20+1.5 -2003+416.5+ 4,-self.electric_wire_length+650+700+350-39+1.5+14.95+ 46.264))
            insts += i3.SRef(name='out_pad20_right', reference=self.hiep_pad_heater_2020,position=(159.45 + 2811+20-35-1.25+ 4,-self.electric_wire_length+650+700+450-32+2.5-25.55+ 46.264))


            insts += i3.SRef(name ='in_pad', reference=self.hiep_pad_heater, position=(1625-50,-self.electric_wire_length+650+700+650+50))
            insts += i3.SRef(name='out_pad', reference=self.hiep_pad_heater,position=(1825-50, -self.electric_wire_length+650+700+650+50))
            insts += i3.SRef(name='wire_in',reference=self.hiep_electric_wire, position=(0, -self.electric_wire_length+500))
            insts += i3.SRef(name='wire_out',reference=self.hiep_electric_wire2,position=(self.pad_spacing, -self.electric_wire_length))
            insts += i3.SRef(name='heater',reference=self.hiep_wire_heater,position=(-2, 0))
