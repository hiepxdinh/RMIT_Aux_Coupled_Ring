...
class Hiephiep(i3.PCell):
    ...
    class Layout(i3.LayoutView):
        ...
        def _default_hiep_electric_wire(self):
            ...
            electric_wire_shape = i3.Shape([(600, 850+1650-80), (-200-150, 850+1650-80), (-200-150, 200), (-27+2.5, 200), (-27+2.5, self.electric_wire_length-500+2.5)])
        ...
        def _default_hiep_electric_wire2(self):
            ...
            electric_wire_shape = i3.Shape([(100+85, 500+2500-65), (100+85, 500+2600), (0, 500+2600), (-1000-150, 500+2600), (-1000-150, 500), (31-2.5, 500), (31-2.5, self.electric_wire_length+2.5)])
            hiep_electric_wire_layout.set(shape=electric_wire_shape)
            return hiep_electric_wire_layout
        ...
        def _generate_instances(self, insts):
            ...
            insts += i3.SRef(name ='in_pad', reference=self.hiep_pad_heater, position=(1625-900-120,-self.electric_wire_length+650+700-350+2000-70))
            insts += i3.SRef(name='out_pad', reference=self.hiep_pad_heater,position=(1825-900-120, -self.electric_wire_length+650+700-350+2000-70))
