...
from heater_outside_2 import Hiephiep_Top
...
class AddDropRingWithAuxOutside2_Top(i3.PCell):
    """
    ...
    class Layout(i3.LayoutView):
        ...
        def _generate_instances(self, insts):
            ...
            # insts += i3.SRef(name='ring_aux_1', reference=self.ring_aux_1, position=(-self.ring_straight_length * 0.45+self.ring_straight_length_aux * 0.5,
            #                                                                           self.ring_radius-506.264- self.ring_wg_width - self.aux_coupling_gap), transformation=i3.VMirror())
            # insts += i3.SRef(name='ring_aux_2', reference=self.ring_aux_1, position=(-self.ring_straight_length * 0.45-self.ring_straight_length_aux * 0.5,
            #                                                                           self.ring_radius-506.264- self.ring_wg_width - self.aux_coupling_gap), transformation=i3.HMirror()+i3.VMirror())
            #
            # ring_aux_1_in = [-self.ring_straight_length * 0.45-self.ring_straight_length_aux * 0.5,
            #                                                                           self.ring_radius-506.264- self.ring_wg_width - self.aux_coupling_gap]
            # ring_aux_2_in = [-self.ring_straight_length * 0.45+self.ring_straight_length_aux * 0.5,
            #                                                                           self.ring_radius-506.264- self.ring_wg_width - self.aux_coupling_gap]
            ...
            ring_aux_1_in = [-self.ring_straight_length * 0.45-self.ring_straight_length_aux * 0.5,
                                                                                      self.ring_radius-506.264*2- self.ring_wg_width - self.aux_coupling_gap]
            ring_aux_2_in = [-self.ring_straight_length * 0.45+self.ring_straight_length_aux * 0.5,
                                                                                      self.ring_radius-506.264*2- self.ring_wg_width - self.aux_coupling_gap]
            ...
            # Heater
            # insts += i3.SRef(name='heater', reference=self.heater,position=(-self.ring_straight_length*0.45-self.ring_straight_length_aux*0.5-self.ring_radius_aux-4, -self.ring_radius-self.ring_radius_aux- self.ring_wg_width-self.aux_coupling_gap- 46.264*2))
