...
gc_position = (3130, 9500)  # Position of the first grating coupler
...
first_ring_position = (-ring_in_pos[0] + bend_radius + 50, -2700)
...
gc_position = (700, 9500)  # Position of the first grating coupler
...
first_ring_position = (-ring_in_pos[0] + bend_radius * 3 + 1090, -4150)
...
chip_layout.write_gdsii("gds_output/ring_modulators_v1.0.gds")